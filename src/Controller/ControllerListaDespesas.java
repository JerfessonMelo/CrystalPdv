...
public class ControllerListaDespesas {
    ...
    @FXML private AnchorPane contentPaneListaDespesas;
    ...
    private void abrirTela(String fxmlFile) {
        try {
            ...
            contentPaneListaDespesas.getChildren().setAll(newContent);
        } catch (IOException e) {
            e.printStackTrace();
            System.err.println("Erro ao carregar a tela: " + fxmlFile);
        }
    }
        @FXML private void VoltaTelaDespesa() {
